 ...
 * (underscore) character. This is similar to the "word character"
 * support in Perl regexps, this gives the set of characters
 * [A-Za-z0-9_]
 *
 */
...
typedef enum {
  ...
  LCFG_OPT_LEGACY         = 4096, /**< Legacy support */
  LCFG_OPT_NEW            = 8192  /**< New (not yet standard) support */
} LCFGOption;
